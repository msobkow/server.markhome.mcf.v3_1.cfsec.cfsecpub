// Description: Java 25 Object interface for CFSecPub ISOTZone.
...
public interface ICFSecPubISOTZoneObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecPubISOTZone.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecPubISOTZoneObj instance which should be subsequently referenced.
	 */
	ICFSecPubISOTZoneObj realise();
	 ...
	 *
	 *	@return	ICFSecPubISOTZoneObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubISOTZoneObj read();
	 ...
	 *	@return	ICFSecPubISOTZoneObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubISOTZoneObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this ISOTZone instance.
	 *
	 *	@return	The newly locked ICFSecPubISOTZoneEditObj edition of this instance.
	 */
	ICFSecPubISOTZoneEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecPubISOTZoneEditObj edition of this instance.
	 */
	ICFSecPubISOTZoneEditObj getEdit();

	/**
	 *	Get the current edition of this ISOTZone instance as a ICFSecPubISOTZoneEditObj.
	 *
	 *	@return	The ICFSecPubISOTZoneEditObj edition of this instance.
	 */
	ICFSecPubISOTZoneEditObj getEditAsISOTZone();

	/**
	 *	Get the ICFSecPubISOTZoneTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecPubISOTZoneTableObj table cache which manages this instance.
	 */
	ICFSecPubISOTZoneTableObj getISOTZoneTable();
	...
	/**
	 *	Get the ICFSecPubISOTZone instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecPubISOTZone instance which currently backs this object.
	 */
	ICFSecPubISOTZone getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecPubISOTZone value );
	 ...
	 *	@return	ICFSecPubISOTZone instance which currently backs this object.
	 */
	ICFSecPubISOTZone getISOTZoneRec();
