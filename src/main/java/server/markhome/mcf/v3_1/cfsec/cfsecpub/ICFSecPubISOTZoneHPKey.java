// Description: Java 25 public interface for a ISOTZone history primary key object
...
/**
 *	ICFSecPubISOTZoneHPKey Public History Primary Key interface for ISOTZone has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredISOTZoneId	Required object attribute ISOTZoneId. */
public interface ICFSecPubISOTZoneHPKey
{
