// Description: Java 25 Public Instance Edit Object interface for CFSec ISOCcy.
...
public interface ICFSecPubISOCcyEditObj
	extends ICFSecPubISOCcyObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecPubISOCcyObj.
	 */
	ICFSecPubISOCcyObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecPubISOCcyObj.
	 */
	ICFSecPubISOCcyObj getOrigAsISOCcy();
	 ...
	 */
	ICFSecPubISOCcyObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecPubISOCcyEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecPubISOCcyEditObj deleteInstance();
	...
	/**
	 *	Get a list ICFSecPubISOCtryCcyObj instances referenced by the Ctry key.
	 *
