// Description: Java 25 public interface for a Cluster record implementation
...
/**
 *	ICFSecPubCluster persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
