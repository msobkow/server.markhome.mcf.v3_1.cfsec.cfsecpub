// Description: Java 25 public interface for a SecSession history primary key object
...
/**
 *	ICFSecPubSecSessionHPKey Public History Primary Key interface for SecSession has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredSecSessionId	Required object attribute SecSessionId. */
public interface ICFSecPubSecSessionHPKey
{
