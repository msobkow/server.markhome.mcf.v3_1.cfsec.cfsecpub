// Description: Java 25 public interface for a SecSysRole history primary key object
...
/**
 *	ICFSecPubSecSysRoleHPKey Public History Primary Key interface for SecSysRole has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredSecSysRoleId	Required object attribute SecSysRoleId. */
public interface ICFSecPubSecSysRoleHPKey
{
