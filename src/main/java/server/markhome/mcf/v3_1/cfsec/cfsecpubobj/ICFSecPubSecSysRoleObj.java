// Description: Java 25 Object interface for CFSecPub SecSysRole.
...
public interface ICFSecPubSecSysRoleObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecPubSecSysRole.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecPubSecSysRoleObj instance which should be subsequently referenced.
	 */
	ICFSecPubSecSysRoleObj realise();
	 ...
	 *
	 *	@return	ICFSecPubSecSysRoleObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubSecSysRoleObj read();
	 ...
	 *	@return	ICFSecPubSecSysRoleObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubSecSysRoleObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SecSysRole instance.
	 *
	 *	@return	The newly locked ICFSecPubSecSysRoleEditObj edition of this instance.
	 */
	ICFSecPubSecSysRoleEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecPubSecSysRoleEditObj edition of this instance.
	 */
	ICFSecPubSecSysRoleEditObj getEdit();

	/**
	 *	Get the current edition of this SecSysRole instance as a ICFSecPubSecSysRoleEditObj.
	 *
	 *	@return	The ICFSecPubSecSysRoleEditObj edition of this instance.
	 */
	ICFSecPubSecSysRoleEditObj getEditAsSecSysRole();

	/**
	 *	Get the ICFSecPubSecSysRoleTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecPubSecSysRoleTableObj table cache which manages this instance.
	 */
	ICFSecPubSecSysRoleTableObj getSecSysRoleTable();
	...
	/**
	 *	Get the ICFSecPubSecSysRole instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecPubSecSysRole instance which currently backs this object.
	 */
	ICFSecPubSecSysRole getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecPubSecSysRole value );
	 ...
	 *	@return	ICFSecPubSecSysRole instance which currently backs this object.
	 */
	ICFSecPubSecSysRole getSecSysRoleRec();
