// Description: Java 25 public interface for a ISOCtryCcy history primary key object
...
/**
 *	ICFSecPubISOCtryCcyHPKey Public History Primary Key interface for ISOCtryCcy has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredISOCtryId	Required object attribute ISOCtryId.
 *		requiredISOCcyId	Required object attribute ISOCcyId. */
public interface ICFSecPubISOCtryCcyHPKey
{
