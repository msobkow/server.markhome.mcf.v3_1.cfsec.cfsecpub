// Description: Java 25 public interface for a ISOCtryLang history primary key object
...
/**
 *	ICFSecPubISOCtryLangHPKey Public History Primary Key interface for ISOCtryLang has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredISOCtryId	Required object attribute ISOCtryId.
 *		requiredISOLangId	Required object attribute ISOLangId. */
public interface ICFSecPubISOCtryLangHPKey
{
