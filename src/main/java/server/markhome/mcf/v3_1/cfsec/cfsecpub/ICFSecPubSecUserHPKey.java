// Description: Java 25 public interface for a SecUser history primary key object
...
/**
 *	ICFSecPubSecUserHPKey Public History Primary Key interface for SecUser has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredSecUserId	Required object attribute SecUserId. */
public interface ICFSecPubSecUserHPKey
{
