// Description: Java 25 Public Instance Edit Object interface for CFSec ISOLang.
...
public interface ICFSecPubISOLangEditObj
	extends ICFSecPubISOLangObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecPubISOLangObj.
	 */
	ICFSecPubISOLangObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecPubISOLangObj.
	 */
	ICFSecPubISOLangObj getOrigAsISOLang();
	 ...
	 */
	ICFSecPubISOLangObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecPubISOLangEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecPubISOLangEditObj deleteInstance();
	...
	/**
	 *	Get a list ICFSecPubISOCtryLangObj instances referenced by the Ctry key.
	 *
	 *	@return	The (potentially empty) list of ICFSecPubISOCtryLangObj instances referenced by the Ctry key.
	 */
