// Description: Java 25 public interface for a SecSysGrp record implementation
...
/**
 *	ICFSecPubSecSysGrp persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFSecPubSecSysGrp
{
