// Description: Java 25 Object interface for CFSecPub Tenant.
...
public interface ICFSecPubTenantObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecPubTenant.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecPubTenantObj instance which should be subsequently referenced.
	 */
	ICFSecPubTenantObj realise();
	 ...
	 *
	 *	@return	ICFSecPubTenantObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubTenantObj read();
	 ...
	 *	@return	ICFSecPubTenantObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubTenantObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this Tenant instance.
	 *
	 *	@return	The newly locked ICFSecPubTenantEditObj edition of this instance.
	 */
	ICFSecPubTenantEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecPubTenantEditObj edition of this instance.
	 */
	ICFSecPubTenantEditObj getEdit();

	/**
	 *	Get the current edition of this Tenant instance as a ICFSecPubTenantEditObj.
	 *
	 *	@return	The ICFSecPubTenantEditObj edition of this instance.
	 */
	ICFSecPubTenantEditObj getEditAsTenant();

	/**
	 *	Get the ICFSecPubTenantTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecPubTenantTableObj table cache which manages this instance.
	 */
	ICFSecPubTenantTableObj getTenantTable();
	...
	/**
	 *	Get the ICFSecPubTenant instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecPubTenant instance which currently backs this object.
	 */
	ICFSecPubTenant getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecPubTenant value );
