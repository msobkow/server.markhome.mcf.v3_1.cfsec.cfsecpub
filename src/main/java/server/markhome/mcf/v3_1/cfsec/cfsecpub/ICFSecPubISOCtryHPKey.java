// Description: Java 25 public interface for a ISOCtry history primary key object
...
/**
 *	ICFSecPubISOCtryHPKey Public History Primary Key interface for ISOCtry has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredISOCtryId	Required object attribute ISOCtryId. */
public interface ICFSecPubISOCtryHPKey
{
