// Description: Java 25 Public Instance Edit Object interface for CFSec SecSysGrp.
...
public interface ICFSecPubSecSysGrpEditObj
	extends ICFSecPubSecSysGrpObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecPubSecSysGrpObj.
	 */
	ICFSecPubSecSysGrpObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecPubSecSysGrpObj.
	 */
	ICFSecPubSecSysGrpObj getOrigAsSecSysGrp();
	 ...
	 */
	ICFSecPubSecSysGrpObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecPubSecSysGrpEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecPubSecSysGrpEditObj deleteInstance();
	...
	/**
	 *	Get the ICFSecPubSecSysRoleObj instance referenced by the ImplSysRole key.
	 *
