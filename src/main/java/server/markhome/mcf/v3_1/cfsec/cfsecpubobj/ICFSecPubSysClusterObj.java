// Description: Java 25 Object interface for CFSecPub SysCluster.
	...
	extends ICFLibAnyObj
{
	 ...
	 *
	 *	@return	CFSecPubSysClusterObj instance which should be subsequently referenced.
	 */
	ICFSecPubSysClusterObj realise();
	 ...
	 *
	 *	@return	ICFSecPubSysClusterObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubSysClusterObj read();
	 ...
	 *	@return	ICFSecPubSysClusterObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubSysClusterObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SysCluster instance.
	 *
	 *	@return	The newly locked ICFSecPubSysClusterEditObj edition of this instance.
	 */
	ICFSecPubSysClusterEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecPubSysClusterEditObj edition of this instance.
	 */
	ICFSecPubSysClusterEditObj getEdit();

	/**
	 *	Get the current edition of this SysCluster instance as a ICFSecPubSysClusterEditObj.
	 *
	 *	@return	The ICFSecPubSysClusterEditObj edition of this instance.
	 */
	ICFSecPubSysClusterEditObj getEditAsSysCluster();

	/**
	 *	Get the ICFSecPubSysClusterTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecPubSysClusterTableObj table cache which manages this instance.
	 */
	ICFSecPubSysClusterTableObj getSysClusterTable();
	...
	/**
	 *	Get the ICFSecPubSysCluster instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecPubSysCluster instance which currently backs this object.
	 */
	ICFSecPubSysCluster getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecPubSysCluster value );
	 ...
	 *	@return	ICFSecPubSysCluster instance which currently backs this object.
	 */
	ICFSecPubSysCluster getSysClusterRec();
