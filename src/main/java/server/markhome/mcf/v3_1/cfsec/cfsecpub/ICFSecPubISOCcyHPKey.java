// Description: Java 25 public interface for a ISOCcy history primary key object
...
/**
 *	ICFSecPubISOCcyHPKey Public History Primary Key interface for ISOCcy has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredISOCcyId	Required object attribute ISOCcyId. */
public interface ICFSecPubISOCcyHPKey
{
