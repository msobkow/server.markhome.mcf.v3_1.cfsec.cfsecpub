// Description: Java 25 Object interface for CFSecPub ISOCtryCcy.
...
public interface ICFSecPubISOCtryCcyObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecPubISOCtryCcy.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecPubISOCtryCcyObj instance which should be subsequently referenced.
	 */
	ICFSecPubISOCtryCcyObj realise();
	 ...
	 *
	 *	@return	ICFSecPubISOCtryCcyObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubISOCtryCcyObj read();
	 ...
	 *	@return	ICFSecPubISOCtryCcyObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubISOCtryCcyObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this ISOCtryCcy instance.
	 *
	 *	@return	The newly locked ICFSecPubISOCtryCcyEditObj edition of this instance.
	 */
	ICFSecPubISOCtryCcyEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecPubISOCtryCcyEditObj edition of this instance.
	 */
	ICFSecPubISOCtryCcyEditObj getEdit();

	/**
	 *	Get the current edition of this ISOCtryCcy instance as a ICFSecPubISOCtryCcyEditObj.
	 *
	 *	@return	The ICFSecPubISOCtryCcyEditObj edition of this instance.
	 */
	ICFSecPubISOCtryCcyEditObj getEditAsISOCtryCcy();

	/**
	 *	Get the ICFSecPubISOCtryCcyTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecPubISOCtryCcyTableObj table cache which manages this instance.
	 */
	ICFSecPubISOCtryCcyTableObj getISOCtryCcyTable();
	...
	/**
	 *	Get the ICFSecPubISOCtryCcy instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecPubISOCtryCcy instance which currently backs this object.
	 */
	ICFSecPubISOCtryCcy getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecPubISOCtryCcy value );
	 ...
	 *	@return	ICFSecPubISOCtryCcy instance which currently backs this object.
	 */
	ICFSecPubISOCtryCcy getISOCtryCcyRec();

	/**
	 *	Get the primary key of this instance.
	 *
	 *	@return	ICFSecPubISOCtryCcyPKey primary key for this instance.
	 */
	ICFSecPubISOCtryCcyPKey getPKey();
	 ...
	 *	This method should only be invoked by implementation internals.
	 *
	 *	@param ICFSecPubISOCtryCcyPKey primary key value for this instance.
	 */
	void setPKey( ICFSecPubISOCtryCcyPKey value );
