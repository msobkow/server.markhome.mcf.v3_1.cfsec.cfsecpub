// Description: Java 25 public interface for a SecSysGrp history primary key object
...
/**
 *	ICFSecPubSecSysGrpHPKey Public History Primary Key interface for SecSysGrp has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredSecSysGrpId	Required object attribute SecSysGrpId. */
public interface ICFSecPubSecSysGrpHPKey
{
