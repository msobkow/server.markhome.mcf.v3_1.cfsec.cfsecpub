// Description: Java 25 public interface for a ISOLang history primary key object
...
/**
 *	ICFSecPubISOLangHPKey Public History Primary Key interface for ISOLang has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredISOLangId	Required object attribute ISOLangId. */
public interface ICFSecPubISOLangHPKey
{
