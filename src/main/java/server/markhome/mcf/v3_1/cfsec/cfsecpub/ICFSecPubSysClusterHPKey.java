// Description: Java 25 public interface for a SysCluster history primary key object
...
/**
 *	ICFSecPubSysClusterHPKey Public History Primary Key interface for SysCluster has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredSingletonId	Required object attribute SingletonId. */
public interface ICFSecPubSysClusterHPKey
{
