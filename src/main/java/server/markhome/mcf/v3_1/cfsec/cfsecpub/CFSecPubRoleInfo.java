...
/*
 *	The CFSecPubRoleInfo objects are passed in to the CFSec schema implementation to be bound
 *	to the security system.  Their natural order is to compare by dependency first, and by name second.
 */
public class CFSecPubRoleInfo implements Serializable, Comparable<CFSecPubRoleInfo>
{
	...
	public CFSecPubRoleInfo(String roleName, String roleScope, String enables, String includes) {
	...
	@Override
	public int compareTo( CFSecPubRoleInfo rhs ) {
		if( rhs == null ) {
			return( 1 );
		}
		else {
