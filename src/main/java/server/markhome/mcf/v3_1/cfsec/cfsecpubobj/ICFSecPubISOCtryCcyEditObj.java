// Description: Java 25 Public Instance Edit Object interface for CFSec ISOCtryCcy.
...
public interface ICFSecPubISOCtryCcyEditObj
	extends ICFSecPubISOCtryCcyObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecPubISOCtryCcyObj.
	 */
	ICFSecPubISOCtryCcyObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecPubISOCtryCcyObj.
	 */
	ICFSecPubISOCtryCcyObj getOrigAsISOCtryCcy();
	 ...
	 */
	ICFSecPubISOCtryCcyObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecPubISOCtryCcyEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecPubISOCtryCcyEditObj deleteInstance();
