// Description: Java 25 public interface for a SecUser history object
...
/**
 *	ICFSecPubSecUserH provides access to public history records matching the CFSecPubSecUser object change history.
 */
public interface ICFSecPubSecUserH
{
