// Description: Java 25 Public Instance Edit Object interface for CFSec SecSysRole.
...
public interface ICFSecPubSecSysRoleEditObj
	extends ICFSecPubSecSysRoleObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecPubSecSysRoleObj.
	 */
	ICFSecPubSecSysRoleObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecPubSecSysRoleObj.
	 */
	ICFSecPubSecSysRoleObj getOrigAsSecSysRole();
	 ...
	 */
	ICFSecPubSecSysRoleObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecPubSecSysRoleEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecPubSecSysRoleEditObj deleteInstance();
