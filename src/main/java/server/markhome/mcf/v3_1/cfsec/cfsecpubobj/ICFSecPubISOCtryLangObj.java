// Description: Java 25 Object interface for CFSecPub ISOCtryLang.
...
public interface ICFSecPubISOCtryLangObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFSecPubISOCtryLang.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFSecPubISOCtryLangObj instance which should be subsequently referenced.
	 */
	ICFSecPubISOCtryLangObj realise();
	 ...
	 *
	 *	@return	ICFSecPubISOCtryLangObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubISOCtryLangObj read();
	 ...
	 *	@return	ICFSecPubISOCtryLangObj the reference to the cached or read (realised) instance.
	 */
	ICFSecPubISOCtryLangObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this ISOCtryLang instance.
	 *
	 *	@return	The newly locked ICFSecPubISOCtryLangEditObj edition of this instance.
	 */
	ICFSecPubISOCtryLangEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFSecPubISOCtryLangEditObj edition of this instance.
	 */
	ICFSecPubISOCtryLangEditObj getEdit();

	/**
	 *	Get the current edition of this ISOCtryLang instance as a ICFSecPubISOCtryLangEditObj.
	 *
	 *	@return	The ICFSecPubISOCtryLangEditObj edition of this instance.
	 */
	ICFSecPubISOCtryLangEditObj getEditAsISOCtryLang();

	/**
	 *	Get the ICFSecPubISOCtryLangTableObj table cache which manages this instance.
	 *
	 *	@return	ICFSecPubISOCtryLangTableObj table cache which manages this instance.
	 */
	ICFSecPubISOCtryLangTableObj getISOCtryLangTable();
	...
	/**
	 *	Get the ICFSecPubISOCtryLang instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFSecPubISOCtryLang instance which currently backs this object.
	 */
	ICFSecPubISOCtryLang getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFSecPubISOCtryLang value );
	 ...
	 *	@return	ICFSecPubISOCtryLang instance which currently backs this object.
	 */
	ICFSecPubISOCtryLang getISOCtryLangRec();

	/**
	 *	Get the primary key of this instance.
	 *
	 *	@return	ICFSecPubISOCtryLangPKey primary key for this instance.
	 */
	ICFSecPubISOCtryLangPKey getPKey();
	 ...
	 *	This method should only be invoked by implementation internals.
	 *
	 *	@param ICFSecPubISOCtryLangPKey primary key value for this instance.
	 */
	void setPKey( ICFSecPubISOCtryLangPKey value );
