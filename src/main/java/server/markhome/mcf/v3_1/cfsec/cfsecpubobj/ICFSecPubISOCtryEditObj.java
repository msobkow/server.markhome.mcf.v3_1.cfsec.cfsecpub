// Description: Java 25 Public Instance Edit Object interface for CFSec ISOCtry.
...
public interface ICFSecPubISOCtryEditObj
	extends ICFSecPubISOCtryObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFSecPubISOCtryObj.
	 */
	ICFSecPubISOCtryObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFSecPubISOCtryObj.
	 */
	ICFSecPubISOCtryObj getOrigAsISOCtry();
	 ...
	 */
	ICFSecPubISOCtryObj create();

	/*
	 *	Update the instance.
	 */
	ICFSecPubISOCtryEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFSecPubISOCtryEditObj deleteInstance();
	...
	/**
	 *	Get a list ICFSecPubISOCtryCcyObj instances referenced by the Ccy key.
	 *
