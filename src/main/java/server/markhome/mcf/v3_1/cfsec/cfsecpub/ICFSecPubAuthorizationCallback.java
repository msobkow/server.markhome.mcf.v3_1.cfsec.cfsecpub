// Description: Java 25 Public Authorization Callback Interface.
...
/*
 *	An ICFSecPubAuthorizationCallback is callback method hook for locating the currently applicable authorization object at runtime.
 */
public interface ICFSecPubAuthorizationCallback
{
	/**
	 ...
	 */
	public ICFSecPubAuthorization getEffectivePubAuthorization();
}
