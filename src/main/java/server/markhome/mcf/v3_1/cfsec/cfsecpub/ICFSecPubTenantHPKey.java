// Description: Java 25 public interface for a Tenant history primary key object
...
/**
 *	ICFSecPubTenantHPKey Public History Primary Key interface for Tenant has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredId	Required object attribute Id. */
public interface ICFSecPubTenantHPKey
{
